	...
	if(blnShow){
		...
		switch(strType){
			case "SWF":
				...
				break;
			case "QT":
				strMedia="<object classid=\"clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B\" codebase=\"http://www.apple.com/qtactivex/qtplugin.cab\" width=\""+intWidth+"\" height=\""+intHeight+"\" ><param name=\"src\" value=\""+strURL+"\" ><param name=\"autoplay\" value=\"true\" ><embed  src=\"http://www.52tony.com/script/qtmimetype.pntg\" type=\"image/x-macpaint\"pluginspage=\"http://www.apple.com/quicktime/download\" qtsrc=\""+strURL+"\" width=\""+intHeight+"\" height=\""+intHeight+"\" autoplay=\"true\" ></embed></object>";
				break;
			case "WMV":
...
function RevertComment(intRevertID) {
	...
	if(f.action.search("act=cmt")>0){
		f.action=f.action.replace("http://www.52tony.com/script/cmd.asp?act=cmt","cmd.asp?act=CommentRev&id="+intRevertID);
		return true;
	}
	else{
