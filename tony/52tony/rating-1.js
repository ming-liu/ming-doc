...
function getPath(){
	...
	for (i=scripts.length-1; i>0; i--)
		if (scripts[i].src != "")
			if(scripts[i].src.toLowerCase().indexOf("rating-1.js"/*tpa=http://www.52tony.com/PLUGIN/Rating/rating.js*/)>0)
				strtmp = scripts[i].src.toLowerCase().replace("rating-1.js"/*tpa=http://www.52tony.com/PLUGIN/Rating/rating.js*/,"");
	if (strtmp!="")
